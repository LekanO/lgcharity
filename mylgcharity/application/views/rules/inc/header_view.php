...
<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="<?=base_url()?>">MY LG</a>
          <div class="nav-collapse collapse">
            ...
            <form id="login_form" class="navbar-form pull-right" method="post" action="<?=site_url('user/login')?>">
              <input class="span2" name="email" type="text" placeholder="Email">
              <input class="span2" name="password" type="text" placeholder="Password">
...
<header class="jumbotron subhead" id="overview">
  ...
  <div class="carousel-inner">
    <div class="active item"><img src="<?=base_url()?>public/img/woman-phone.png" /></div>
    <div class="item"><img src="<?=base_url()?>public/img/hello-africa.png" /></div>
    <div class="item"><img src="<?=base_url()?>public/img/vouchers.png" /></div>
  </div>
  <!-- Carousel nav -->
